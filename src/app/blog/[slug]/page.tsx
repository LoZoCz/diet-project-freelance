...
import PostInfo from '@/components/custom/PostPage/PostInfo'
import PostMainImage from '@/components/custom/PostPage/PostMainImage'
import Formatter, { H1 } from '@/components/custom/typography'
