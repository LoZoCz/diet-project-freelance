...
const HeroSection: FC = () => {
    return (
        <section className="after-hero flex h-screen w-full flex-col items-center bg-hero-image bg-cover bg-center px-4 tablet:flex-row">
            <div className="flex flex-col gap-5 py-12 md:pl-8">
                ...
                <P className="text-lg text-white tablet:max-w-[65ch]">
